---
name: ms-teams-setup
description: Connect Microsoft Teams for cross-channel context awareness. Use when
  the user says 'connect Teams', 'hook up Microsoft'. Not for Google email/calendar;
  use `google-workspace-setup`.
---
# Teams Setup
