...
<!-- Generated from `.claude/skills/zoom-setup/SKILL.md` by `scripts/generate-agents-skills.py`. Do not edit. -->
...
You can only access a meeting's assets or recordings when you **hosted** that meeting or were
