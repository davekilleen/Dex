...
- [ ] @Sarah: Scope analytics requirements
...
- After meetings, I draft follow-up tasks and flag commitments
- When you ask about an account or project, I pull together everything we know
- Before stakeholder meetings, I surface recent context and open items
...
- User research tools (Dovetail, Notion)
- Analytics (Amplitude, Mixpanel)

## Size Variants

### 1-100 (Startup)
- Generalist PM — own everything
- Direct customer access
- Ship fast, iterate faster
- Less process, more action
- Founder relationship critical

### 100-1k (Scaling)
- Define repeatable processes
- Build PM playbooks
- Cross-team coordination grows
- Hiring and onboarding PMs
