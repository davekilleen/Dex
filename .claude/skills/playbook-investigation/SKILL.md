...
description: "Read-only 'how does X work / why was it built this way / are we sure' requests that produce a cited explanation or recommendation, not a code change; load when the task is investigation-shaped."
---
