---
name: playbook-pause-safely
description: "Stopping mid-task cleanly with a checkpoint a cold-start agent can resume from; load for 'pause safely', 'I need to go offline', a harness restart, or imminent context compaction. Explicit only — never on 'keep going'."
---
