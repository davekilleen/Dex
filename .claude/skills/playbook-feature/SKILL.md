...
description: "Owning a feature build — design first, write the throughput checkpoint, delegate implementation with a specific scope, verify on the matching surface, open a PR; load when the task adds behavior."
---
