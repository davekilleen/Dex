---
name: playbook-session-pickup
description: "Resuming another agent's work from a transcript, handoff URL, or pushed branch without redoing it; load for 'take over this', 'resume this conversation', 'pick up where X left off'."
---
