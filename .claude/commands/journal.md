...
1. Update CLAUDE.md User Profile to set `Journaling: Enabled`
...
1. Update CLAUDE.md User Profile to set `Journaling: Disabled`
...
Add to User Profile section when enabled:

```markdown
**Journaling:** Enabled
**Journal Location:** Inbox/Journals/
```
