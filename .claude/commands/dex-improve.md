...
```
Resources/Learnings/                 # What you've learned so far
...
3. Add any new patterns to `Resources/Learnings/`
...
1. **Read state file:** `Resources/Claude_Code_Docs/capability-state.json`
   - If missing, this is first run — do a full scan instead

2. **Fetch current changelog:** Search web for Claude Code changelog/releases
...
Location: `Resources/Claude_Code_Docs/capability-state.json`

```json
{
  "last_check": "2026-01-22",
  "last_changelog_version": "1.0.30",
  "capabilities_seen": [
    "hooks",
    "sub-agents", 
    "skills",
...
1. **Inventory current usage:**
   ...
   - Read `Resources/Learnings/` for known patterns
