...
> **Compatibility note:** `docs/Dex_System/` is the brain-owned home for this documentation going forward. Matching copies remain in `06-Resources/Dex_System/` for now so existing links and vaults keep working during this bridge release.
