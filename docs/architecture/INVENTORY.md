...
<!-- Content SHA-256: 482ef7444624ea280f759a815b6e478da627532a5ba491673a98c5488bfe504b -->
...
| `dex-onboarding-mcp` | `core/mcp/onboarding_server.py` | 12 | no | `check_onboarding_complete`, `cleanup_qa_session`, `finalize_onboarding`, `get_onboarding_status`, `prepare_entity_page_offer`, `respond_to_entity_page_offer`, `run_first_week_analysis`, `save_calendar_selection`, `set_entity_creation_default`, `start_onboarding_session`, `validate_and_save_step`, `verify_dependencies` |
