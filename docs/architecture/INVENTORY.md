...
<!-- Content SHA-256: d176e7ceff1ad967d0ccc56cf09fb0d6d8b363c60944459331158578cc0d717b -->
...
| `dex-onboarding-mcp` | `core/mcp/onboarding_server.py` | 13 | no | `check_onboarding_complete`, `cleanup_qa_session`, `finalize_onboarding`, `generate_nudge_calendar`, `get_onboarding_status`, `prepare_entity_page_offer`, `respond_to_entity_page_offer`, `run_first_week_analysis`, `save_calendar_selection`, `set_entity_creation_default`, `start_onboarding_session`, `validate_and_save_step`, `verify_dependencies` |
