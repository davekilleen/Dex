...
<!-- Content SHA-256: 9425f63da071266225506605e4d8d7b1874824e8a20949e51b5f1fc88661ca78 -->
...
| `dex-onboarding-mcp` | `core/mcp/onboarding_server.py` | 10 | no | `check_onboarding_complete`, `cleanup_qa_session`, `finalize_onboarding`, `generate_nudge_calendar`, `get_onboarding_status`, `run_first_week_analysis`, `save_calendar_selection`, `start_onboarding_session`, `validate_and_save_step`, `verify_dependencies` |
