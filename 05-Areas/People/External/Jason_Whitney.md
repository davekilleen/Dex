...
- Tasked with blending Regis's slides with current one-pager into single updated deck
- Active in client-facing meetings alongside Jason Wadler
- **Fundraising expertise:** Recommends "pre-seed" → "seed" → "series A" framing. "What you call it changes how it's perceived." Can raise $3M in Midwest but not $15M on limited revenue.
- **Prior matchmaking attempt:** Tried to build a VC-to-company matchmaking platform at Fencing — got strong response but developers couldn't execute. Validated Wisory's marketplace concept: "That's literally the exact same thing I tried to build before"
- **Heritage Group connection:** Booked face-to-face meeting. Indianapolis-based family fund ($50M/year) from Milestone Construction. Bought entire Duke Ventures team.
