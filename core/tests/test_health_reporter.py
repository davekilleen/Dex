...
def test_doctor_report_is_normalized_across_the_complete_registry():
    ...
    # 34 since the Pipedrive CRM connection probe joined the deep checks. This
    # literal is a deliberate tripwire: adding a probe must be acknowledged here.
    assert len(envelope.results) == 34
