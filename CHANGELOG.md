...
* **The preview hour is a conversation, not a form.** Dex asks you to talk — hold the microphone if that is easier — and to share last year’s review if you have it. It looks at three weeks of meetings, not one, so it can spot regular 1:1s and people you keep close. It asks one question, then waits. It talks about the next working day, not a made-up Tuesday.
