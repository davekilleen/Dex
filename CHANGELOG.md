...
* **The practice first hour starts with a hello.** The starter finishes the behind-the-scenes setup before you open the folder, so you are not asked to restart after a wall of setup talk. Opening the folder no longer kicks off the old question list.
