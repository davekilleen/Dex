...
* **The practice first hour starts with a hello.** The starter finishes a fresh Dex copy before you open the folder — including the folders people and company pages need — so you are not asked to restart after a wall of setup talk. Opening the folder no longer kicks off the old question list.
...
* **The preview hour is a conversation, not a form.** Dex asks you to talk — hold the microphone if that is easier — and to share last year’s review, your job spec, or a LinkedIn extract if you have it. It looks at three weeks of meetings, not one, so it can spot regular 1:1s and people you keep close. It reads those meetings itself instead of sending someone off and going quiet. A helper may look up your company in the background — you’ll hear what that is for, not a name. It never fills the gap with “one moment.” Your next working morning is a real date, and if you’re out of office it skips ahead to the day you’re actually back. A new preview does not pick up yesterday’s half-finished hour.
